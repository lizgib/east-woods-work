...
dat.herb.spring.07.o <- read.csv('spp.herb.2007.csv', as.is = T)
...
dat.herb.spring.18.o <- read.csv('spp.herb.2018.csv', as.is = T)
dat.herb.spring.18 <- dat.herb.spring.18.o[3:6]
dat.herb.fall.18.o <- read.csv('sum.herb.2018.csv', as.is = T)
dat.herb.fall.18 <- dat.herb.fall.18.o[3:6]
dat.shrub.spring.18.o <- read.csv('spp.shrub.2018.csv', as.is = T)
...
dat.shrub.fall.18.o <- read.csv('sum.shrub.2018.csv', as.is = T)
...
dat.tree.spring.18.o <- read.csv('spp.tree.2018.csv', as.is = T)
dat.tree.spring.18 <- dat.tree.spring.18.o[3:6]
dat.tree.fall.18.o <- read.csv('sum.tree.2018.csv', as.is = T)
...
dat.07.1 <- rbind(dat.07.1, dat.shrubs07, dat.trees07)
######################################################################################################
#2018 
...
dat.shrubs18 <- rbind(dat.shrub.spring.18, dat.shrub.fall.18)
