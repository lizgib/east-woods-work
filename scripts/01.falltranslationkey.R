...
removed_spp <- read_excel(file.path('data/species/removed_spp.xlsx'), sheet = "Sheet1")
...
dat.all$accepted_name[which(dat.all$species %in% remove_these)] <- removed_spp$Resolve[match(removed_spp$`Species Name`,dat.all$species)]
