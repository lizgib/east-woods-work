...
# phylogenetic diversity of plot canopy 
...
diversity$SR07 <- phylo_all_07$ntaxa[match(diversity$plots, phylo_all_07$Plot)]
diversity$PD07 <- phylo_all_07$pd.obs[match(diversity$plots, phylo_all_07$Plot)]
diversity$PDunder07 <- phylo_understory_07$pd.obs[match(diversity$plots, phylo_understory_07$Plot)]
diversity$PDtree07 <- phylo_trees_07$pd.obs[match(diversity$plots, phylo_trees_07$Plot)]
diversity$PBD07 <- pbd_all_07$mntd.obs[match(diversity$plots, phylo_all_07$Plot)]
diversity$PBDunder07 <- pbd_understory_07$mntd.obs[match(diversity$plots, pbd_understory_07$Plot)]
diversity$PBDtree07 <- pbd_trees_07$mntd.obs[match(diversity$plots, pbd_understory_07$Plot)]

diversity$SR18 <- phylo_all_18$ntaxa[match(diversity$plots, phylo_all_18$Plot)]
diversity$PD18 <- phylo_all_18$pd.obs[match(diversity$plots, phylo_all_18$Plot)]
diversity$PDunder18 <- phylo_understory_18$pd.obs[match(diversity$plots, phylo_understory_18$Plot)]
diversity$PDtree18 <- phylo_trees_18$pd.obs[match(diversity$plots, phylo_trees_18$Plot)]
diversity$PBD18 <- pbd_all_18$mntd.obs[match(diversity$plots, phylo_all_18$Plot)]
diversity$PBDunder18 <- pbd_understory_18$mntd.obs[match(diversity$plots, pbd_understory_18$Plot)]
diversity$PBDtree18 <- pbd_trees_18$mntd.obs[match(diversity$plots, pbd_understory_18$Plot)]
